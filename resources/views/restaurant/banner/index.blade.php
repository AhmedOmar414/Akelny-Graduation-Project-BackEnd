...
@section('main-content')
 ...
 <div class="card shadow mb-4">
     <div class="row">
         <div class="col-md-12">
            @include('restaurant.layouts.notification')
         </div>
     </div>
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">Banners List</h6>
      <a href="{{url('/restaurant/banner/create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add Banner</a>
    </div>
    <div class="card-body">
            ...
            @foreach($banners as $banner)
                <tr>
                    ...
                    <td>
                        ...
                        <form method="POST" action="{{route('restaurant/banner',[$banner->id])}}">
                          @csrf
                          @method('delete')
