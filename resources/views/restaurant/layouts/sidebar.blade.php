<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{url('/restaurant/home')}}">
    ...
    <li class="nav-item active">
      <a class="nav-link" href="{{url('/restaurant/home')}}">
    ...
    <!-- Nav Item - Charts -->
    <li class="nav-item">
        <a class="nav-link" href="{{url('/restaurant/file-manager')}}">
    ...
    <li class="nav-item">
      ...
      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
          ...
          <a class="collapse-item" href="{{url('/restaurant/banner')}}">Banners</a>
          <a class="collapse-item" href="{{url('/restaurant/banner/create')}}">Add Banners</a>
        </div>
      </div>
    </li>
    <!-- Divider -->
    ...
    <li class="nav-item">
        ...
        <div id="categoryCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{url('/restaurant/category')}}">Category</a>
          </div>
        </div>
    </li>
    {{-- Products --}}
