                            ...
                            <form action="{{route('category.store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-outline mb-4">
                                        ...
                                        <input type="text" id="form3Example8" class="form-control form-control-lg" name="name" placeholder="category Name"/>
                                    </div>
                                    @error('name')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                    ...
                                    <div class="form-outline mb-4">
                                        ...
                                        <select  id="status" name="status"  class="form-control form-control-lg" onclick="console.log($(this).val())"
                                            ...
                                            <!--placeholder-->
                                            <option  selected style="color: black" value={{\App\Models\Category::FOUND}}> Found</option>
