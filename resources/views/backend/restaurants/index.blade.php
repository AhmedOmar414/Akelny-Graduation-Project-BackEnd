...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('restaurants.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Add Restaurant</a>
    </div>
    <div class="card-body">
          ...
          <tbody>
            @foreach($users as $user)
                <tr>
                    ...
                    <td>
                        <a href="{{route('restaurants.edit',$user->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
                    <form method="POST" action="{{route('restaurants.destroy',[$user->id])}}">
                      @csrf
                      @method('delete')
