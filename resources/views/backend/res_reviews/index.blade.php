                ...
                <tr>
                    ...
                    <td>
                     <ul style="list-style:none">
                          @for($i=1; $i<=5;$i++)
                          @if($review->rate >=$i)
                            <li style="float:left;color:#109dda;"><i class="fa fa-star"></i></li>
                          @else
                            <li style="float:left;color:#109dda;"><i class="far fa-star"></i></li>
                          @endif
                        @endfor
                     </ul>
                    </td>
                    ...
                    <td>
                        <form method="POST" action="{{route('res_review.destroy',[$review->id])}}">
                          @csrf
                          @method('delete')
