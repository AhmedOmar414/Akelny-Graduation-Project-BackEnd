    ...
    <div class="form  ">
        ...
        <div class="inputs-form">
            <div class="mb-3">
                ...
                <input type="text" name="name"  class="form-control" placeholder="Enter Name" id="exampleInputUsername" >
            </div>
            <div class="mb-3">
                <label for="exampleInputEmail" class="form-label">Email</label>
                <input type="email" name="email" class="form-control" placeholder="enter email" id="exampleInputEmail" >
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type = "password" name = "password_confirmation" placeholder = "password" min= "8" class = "form-control" value="" id="in5">
            </div>
            <div class="mb-3">
                <label for="exampleInputMobileNumber" class="form-label">Mobile Number</label>
                <input type="number" name="mobile" class="form-control" placeholder="Enter Mobile" id="exampleInputMobileNumber" >
            </div>
