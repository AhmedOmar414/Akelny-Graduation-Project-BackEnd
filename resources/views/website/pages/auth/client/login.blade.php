                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-xl-6">
                                <div class="card-body p-md-5 text-black">
                                    ...
                                    <form method="POST"  autocomplete="off" action="{{route('client.login')}}" enctype="multipart/form-data">
                                        @if ($errors->any())
                                    ...
                                    <br>
                                    <a style="text-align: center;margin-left: 90px" href="{{route('client-register')}}"> Create An Account </a>
                                </div>
                            </div>
                        </div>
                    </div>
